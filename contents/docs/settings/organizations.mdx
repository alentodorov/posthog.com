...
By default, only organization admins and owners can create new projects. Enable **Members can create new projects** to let all organization members create projects.

When enabled, organization admins and owners receive an in-app notification each time a member creates a project. The notification links to the new project's settings so admins can review or remove it if needed.

Find this setting in the [Members section](https://app.posthog.com/settings/organization-members) of organization settings under **Project settings**.
